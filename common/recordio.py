...
class RecordWriter(object):
    ...
    def __init__(self, fp):
        ...
        if ('w' not in self.fp.mode and \
                ...
                '+' not in self.fp.mode):
                    logging.error("""Filehandle supplied to RecordWriter does
                            not appear to be writeable.""")
...
class RecordReader(object):
    ...
    def __init__(self, fp):
        ...
        if ('w' in self.fp.mode or 'a' in self.fp.mode) and \
                '+' not in self.fp.mode:
                    logging.error("""Filehandle supplied to RecordReader does
                            not appear to be readable.""")
